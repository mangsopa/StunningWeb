        ...
        function confirmDelete(url) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    // Panggil fungsi deleteRole untuk menghapus data
                    deleteRole(url);
                }
            });
        }
        ...
        function deleteRole(url) {
            ...
            fetch(url, {
                ...
                .then(response => {
                    ...
                    throw new Error('Failed to delete role'); // Handle non-OK response
                })
                .then(data => {
                ...
                .catch(error => {
                    // Tampilkan pesan error jika terjadi kesalahan dalam penghapusan
                    Swal.fire({
                        title: "Error!",
                        text: error.message,
                        icon: "error"
