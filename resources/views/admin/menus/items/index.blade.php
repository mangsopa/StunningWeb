            ...
            <div class="main-body">
                <div class="page-wrapper">
                    ...
                    <div class="m-b-15">
                        ...
                        @include('components.modal.menu-item.add')
                                                                ...
                                                                <div class="dropdown-primary dropdown">
                                                                    ...
                                                                    <ul class="show-notification notification-view dropdown-menu"
                                                                        ...
                                                                        <button type="button"
                                                                            ...
                                                                            onclick="confirmDelete('{{ route('admin.menus.items.destroy', [$menu->id, $data->id]) }}')">Delete</button>
                                                                    </ul>
                                                                    @include('components.modal.menu-item.edit')
                                                                </div>
                                                            </td>
