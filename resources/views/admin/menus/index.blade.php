        ...
        <div class="pcoded-content">
            <div class="main-body">
                <div class="page-wrapper">
                            ...
                            <div class="col-lg-8">
                                <div class="page-header-title">
                                    <div class="d-inline">
                                        ...
                                        <span>Mengatur Display menu pada sidebar dashboard</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                    ...
                    <div class="m-b-15">
                        <x-primary-button class="m-b-10 waves-effect md-trigger rounded-xl bg-blue-700 w-full"
                            data-modal="modal-1">
                            {{ __('+ Add') }}
                        </x-primary-button>
                        
                        @include('components.modal.menu.add')
                    </div>
                                                                ...
                                                                <div class="dropdown-primary dropdown">
                                                                    ...
                                                                    <ul class="show-notification notification-view dropdown-menu"
                                                                        ...
                                                                        <a class="dropdown-item"
                                                                            href="{{ route('admin.menus.items.index', $data->id) }}">Manage
                                                                            Items</a>
                                                                        ...
                                                                        <button type="button"
                                                                            ...
                                                                            onclick="confirmDelete('{{ route('admin.menus.destroy', $data->id) }}')">Delete</button>
                                                                    </ul>
                                                                    @include('components.modal.menu.edit')
                                                                </div>
                                                            </td>
