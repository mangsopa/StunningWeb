...
<div class="md-modal md-effect-11" id="modal-edit{{ $data->id }}" style="z-index: 5;">
      <div class="md-content">
          ...
          <div>
              <form method="POST" action="{{ route('admin.menus.items.update', [$menu->id, $data->id]) }}">
                  @csrf
                  @method('PUT')
                  ...
                  <div class="py-4 px-4 text-black text-2lg">
                      ...
                      <div class="mt-4">
                          ...
                          <x-text-input id="icon" class="block mt-1 w-full" type="text" name="icon"
                              :value="$data->icon" required autofocus autocomplete="icon" />
                      ...
                      <div class="mt-4">
                          ...
                          <select class="js-example-data-array" name="route" id="route">
                              ...
                              <option @selected($data->route == $route->getName()) value="{{ $route->getName() }}">{{ $route->getName() }}</option>
                              @endif
                              @endforeach
                          </select>
